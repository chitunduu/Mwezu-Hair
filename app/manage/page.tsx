...
export const metadata = {
    title: "Manage Your Booking | Mwezu Hair Salon",
    description: "View, reschedule or cancel your Mwezu Hair appointment.",
};
            ...
            <main className="mx-auto max-w-xl px-4 py-12">
                <div className="mb-10 text-center">
                    ...
                    <p className="mt-3 text-sm" style={{ color: "#9B896E" }}>
                        Enter your phone number to find your upcoming appointment.
                    </p>
                </div>
                <ManageFlow />
            </main>
